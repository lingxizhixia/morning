<%@ Page Title="" Language="C#" MasterPageFile="~/base.Master" AutoEventWireup="true" CodeBehind="bike8.aspx.cs" Inherits="Dawn.Web.bike.bike8" %>
        ...
        <div class="con-right">
            <div class="right-box">
                <div class="right-show">
                    <div class="cp-name">KD2608Z  FOB:355 EURO</div>
                    <div class="cp-pic1">

                        <li style="display: block;">
                            <img src="../images/bike/IMG_0448.JPG" id="bigImg" style="max-width: 500px;" alt="KD2610Z-G FOB：459 Euro" /></li>
                    </div>
                    <div class="cp-pic2">
                        <ul>
                        </ul>
                            ...
                            <table width="698" border="1" cellpadding="0" cellspacing="1" style="background: rgb(232, 246, 255); display: table; border-color: #d7d7d7; border-width: 1px;">
                                <tr>
                                    <td height="28" colspan="2" align="center" bgcolor="#e8f6ff">
                                        <strong>KD2608Z&nbsp;-Electric System</strong>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">Option: 24V 10Ah Li-ion battery</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">
                                        <p>
                                            e-bike mode 20-35km<br />
                                            Pedaling-Electric mode 35-45km
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">98pcs/20' , 210pcs/40',   226pcs/40' HQ</td>
                                </tr>
                    ...
                    <div class="cp-con">
                        <div class="cp-tab">
                            <table width="698" border="1" cellpadding="0" cellspacing="1" style="background: rgb(232, 246, 255); display: table; border-color: #d7d7d7; border-width: 1px;">
                                <tr>
                                    <td height="28" colspan="2" align="center" bgcolor="#e8f6ff">
                                        <strong>KD2608Z&nbsp;-Components</strong>
                                    </td>
                                </tr>
                                    <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">26"×1.75, puncture resistant </td>
                                </tr>
                                  <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">V brakes</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">6-class Shimano</td>
                                </tr>
