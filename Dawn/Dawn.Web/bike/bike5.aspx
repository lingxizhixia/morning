<%@ Page Title="" Language="C#" MasterPageFile="~/base.Master" AutoEventWireup="true" CodeBehind="bike5.aspx.cs" Inherits="Dawn.Web.bike.bike5" %>
        ...
        <div class="con-right">
            <div class="right-box">
                <div class="right-show">
                    <div class="cp-name">KD7004Z  FOB:498 EURO</div>
                    <div class="cp-pic1">

                        <li style="display: block;">
                            <img src="../images/bike/DSC02455.JPG" id="bigImg" style="max-width: 500px;" alt="KD7004Z  FOB:498 EURO" /></li>
                    </div>
                    <div class="cp-pic2">
                        <ul>
                        </ul>
                            ...
                            <table width="698" border="1" cellpadding="0" cellspacing="1" style="background: rgb(232, 246, 255); display: table; border-color: #d7d7d7; border-width: 1px;">
                                <tr>
                                    <td height="28" colspan="2" align="center" bgcolor="#e8f6ff">
                                        <strong>KD7004Z&nbsp;-Electric System</strong>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="cp-con">
                        <div class="cp-tab">
                            <table width="698" border="1" cellpadding="0" cellspacing="1" style="background: rgb(232, 246, 255); display: table; border-color: #d7d7d7; border-width: 1px;">
                                <tr>
                                    <td height="28" colspan="2" align="center" bgcolor="#e8f6ff">
                                        <strong>KD7004Z&nbsp;-Components</strong>
                                    </td>
                                </tr>
                                    <tr>
