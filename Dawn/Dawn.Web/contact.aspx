<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Dawn.Web.contact" %>
...
<div width="456" border="0" cellpadding="0" cellspacing="0">
   <div>
      <div height="28" valign="top" class="contact_subject"><span class="header_1">Name</span><br>Add your name</div>
      <div><input name="name" type="text" class="text_field"></div>
   </div>
   ...
   <div style="padding-left:158px; padding-top:20px; ">
      <div valign="top" align="left"><input name="submit" type="image" src="images/send_btn.jpg" value="Submit"></div>
   </div>
