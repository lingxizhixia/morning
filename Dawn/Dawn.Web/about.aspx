<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="Dawn.Web.about" %>
...
<!-------------------------------------------------------- left box start -------------------------------------------------------->
	...
	<div class="other_left_box">
	    ...
	    <div class="content"><span class="header_1">Mauris ultrices dignissim tellus, sed posuere augue euismod eget. </span><br>
		Morbi semper posuere nisl id consectetur. Donec sodales, leo a ullamcorper blandit, dolor sem tincidunt odio, sed pretium sapien tellus vitae magna. Nullam commodo est vel urna vehicula aliquam aliquet est fermentum. Integer hendrerit quam sed turpis aliquet eleifend.</div>
		<div class="about_img_frame"><img src="images/img_01.jpg"></div>
		...
		<div class="content">Sed augue nibh, volutpat iaculis posuere sit amet, luctus eu leo. Sed laoreet, mi quis lobortis mattis, purus nulla euismod tellus eu ullamcorper nisi mi vitae nulla. Sed augue nibh, volutpat iaculis posuere sit amet, luctus eu leo mattis.</div><br>
		<div class="content"><span class="header_1">Fusce mauris felis, imperdiet sed sollicitudin non</span><br>
...
<!-------------------------------------------------------- right box 1 start -------------------------------------------------------->
	...
	<div class="other_right_box1">
		...
		<div><a href="#" class="right_band_links">Company History</a></div>
		<div><a href="people.htm" class="right_band_links">Our People</a></div>
		<div><a href="#" class="right_band_links">Vision, Mission and Goal</a></div>
	</div>
<!-------------------------------------------------------- right box 1 end -------------------------------------------------------->	
<!-------------------------------------------------------- right box 2 start -------------------------------------------------------->
	...
	<div class="other_right_box2">
	    ...
	    <div class="content" style="padding-top:10px; ">John Doe <br> Creative Head  |  <a href="#" class="blue_link">Congo Interactive</a></div>
