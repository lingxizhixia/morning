        ...
        <div class="con-right">
            <div class="right-box">
                <div class="right-show">
                    <div class="cp-name">KDZ-2610Z-P  FOB：422 EURO</div>
                    <div class="cp-pic1">

                        <li style="display: block;">
                            <img src="../images/bike/DSC02357.JPG" id="bigImg" style="max-width: 500px;" alt="KDZ-2610Z-P  FOB：422 EURO" /></li>
                    </div>
                    <div class="cp-pic2">
                        <ul>
                        </ul>
                            ...
                            <table width="698" border="1" cellpadding="0" cellspacing="1" style="background: rgb(232, 246, 255); display: table; border-color: #d7d7d7; border-width: 1px;">
                                <tr>
                                    <td height="28" colspan="2" align="center" bgcolor="#e8f6ff">
                                        <strong>KKDZ-2610Z-P&nbsp;-Electric System</strong>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="161" height="28" bgcolor="#FFFFFF">
                                        <p>
                                            ...
                                            <br />
                                            Option: Pure Electric Run Model
                                            <br />
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">Li-ion battery 3.3 kgs</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">1390X270X720 mm</td>
                                </tr>
                    ...
                    <div class="cp-con">
                        <div class="cp-tab">
                            <table width="698" border="1" cellpadding="0" cellspacing="1" style="background: rgb(232, 246, 255); display: table; border-color: #d7d7d7; border-width: 1px;">
                                <tr>
                                    <td height="28" colspan="2" align="center" bgcolor="#e8f6ff">
                                        <strong>KDZ-2610Z-P&nbsp;-Components</strong>
                                    </td>
                                </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">26"×1.75", puncture resistant K-shield</td>
                                </tr>
                                  <tr>
