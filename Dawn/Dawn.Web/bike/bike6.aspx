<%@ Page Title="" Language="C#" MasterPageFile="~/base.Master" AutoEventWireup="true" CodeBehind="bike6.aspx.cs" Inherits="Dawn.Web.bike.bike6" %>
        ...
        <div class="con-right">
            <div class="right-box">
                <div class="right-show">
                    <div class="cp-name">KD7001Z  FOB:455 EURO</div>
                    <div class="cp-pic1">

                        <li style="display: block;">
                            <img src="../images/bike/IMG_0445.JPG" id="bigImg" style="max-width: 500px;" alt="KD7001Z  FOB:455 EURO" /></li>
                    </div>
                    <div class="cp-pic2">
                        <ul>
                        </ul>
                            ...
                            <table width="698" border="1" cellpadding="0" cellspacing="1" style="background: rgb(232, 246, 255); display: table; border-color: #d7d7d7; border-width: 1px;">
                                <tr>
                                    <td height="28" colspan="2" align="center" bgcolor="#e8f6ff">
                                        <strong>KD7001Z&nbsp;-Electric System</strong>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">1700X260X705 mm</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">90pcs/20' , 186pcs/40',   206pcs/40' HQ</td>
                                </tr>
                    ...
                    <div class="cp-con">
                        <div class="cp-tab">
                            <table width="698" border="1" cellpadding="0" cellspacing="1" style="background: rgb(232, 246, 255); display: table; border-color: #d7d7d7; border-width: 1px;">
                                <tr>
                                    <td height="28" colspan="2" align="center" bgcolor="#e8f6ff">
                                        <strong>KD7001Z&nbsp;-Components</strong>
                                    </td>
                                </tr>
                                    <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td width="181" height="28" bgcolor="#FFFFFF">700c×1.75, puncture resistant </td>
                                </tr>
                                  <tr>
